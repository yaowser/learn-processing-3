...
primaries (r, y, b)
secondaries(g, p, o)
tertiaries(y-o, r-o, r-p, b-p, b-g, y-g)
*/
int segs = 12;
...
for (int j=1; j<5; j+=1){
color[]cols = {
color(255/j, 255/j, 0), color(255/j, (255/1.5)/j, 0), 
color(255/j, (255/2)/j, 0), color(255/j, (255/2.5)/j, 0), 
color(255/j, 0, 0), color(255/j, 0, (255/2)/j), 
color(255/j, 0, 255/j), color((255/2)/j, 0, 255/j), 
color(0, 0, 255/j), color(0, 255/j, (255/2)/j), 
color(0, 255/j, 0), color((255/2)/j, 255/j, 0)
};
for (int i=0; i<segs; i++){
fill(cols[i]);
arc(x, y, radius, radius, interval*i+rotAdjust, 
