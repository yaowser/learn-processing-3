...
cubes[i] = new Cube(int(random(-20, 20)), int(random(-20, 20)), int(random(-20, 20)), int(random(-340, 340)), 
int(random(-340, 340)), int(random(-340, 340)));
}
frameRate(30);
}
void draw(){
...
/*center geometry in display window.
